    ...
    private fun parseThemeFile(file: File, loadMessages: MutableList<String>): Result<KKCThemeDefinition> {
        return runCatching {
            ...
            val lightStatus = LightStatusColors.copy(
                ...
                completeBgRow = color(statusObj, "completeBgRow") ?: color(statusObj, "complete") ?: LightStatusColors.completeBgRow,
                ...
                skipBgRow = color(statusObj, "skipBgRow") ?: color(statusObj, "skip") ?: LightStatusColors.skipBgRow,
            ...
            val darkStatus = DarkStatusColors.copy(
                ...
                completeBgRow = color(statusObj, "completeBgRow") ?: color(statusObj, "complete") ?: DarkStatusColors.completeBgRow,
                ...
                skipBgRow = color(statusObj, "skipBgRow") ?: color(statusObj, "skip") ?: DarkStatusColors.skipBgRow,
