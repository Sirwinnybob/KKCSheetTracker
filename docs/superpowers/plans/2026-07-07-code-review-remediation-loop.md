...
- `Done evidence`: Fixed by moving listener registration to AppNavigation and removing it from MultiBackStackNavigation.
...
- Test command: `.\gradlew.bat :app:testDebugUnitTest --tests com.kkc.sheettracker.navigation.*`.
- Result: passed.
